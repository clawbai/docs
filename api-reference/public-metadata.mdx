...
```json
{
  ...
  "jwks_uri": "https://api.clawb.ai/api/.well-known/clawb/jwks.json",
...
Returns active and previous issuer public keys in JWK format.
...
```bash
curl -sS https://api.clawb.ai/api/.well-known/clawb/jwks.json
```
