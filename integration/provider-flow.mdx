...
This page is for enterprise backend teams and relying services.
...
In addition to request-time verify/check, enterprise teams now run a workspace control plane.
...
3. Control-plane jobs sync workspace inventory and export audits.
...
control_plane.workspace_audit_events(limit=50)
control_plane.identity_credentials_mint(agent_id="agt_01...", ttl_seconds=300)
```

## Next steps

- [Workspace control plane tutorial](/integration/provider-control-plane-tutorial)
