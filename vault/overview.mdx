...
Clawb Vault is the secret-management subsystem of the agent control plane. It lets humans and organizations store **secrets** (API keys, tokens, passwords, certificates, and arbitrary environment variables) and let approved agents use them **without leaking the raw value**.
